"""
Django settings for PubGST project.
...
SECRET_KEY = os.environ.get("SECRET_KEY", "2232131231")
...
STATIC_URL = 'PubGStats/static/'
STATIC_ROOT = os.path.join(BASE_DIR, 'PubGStats/static')
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'PubGStats/static'),
]
